  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold shadow-glow-primary hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        heroSecondary: "bg-gradient-to-r from-secondary to-secondary/80 text-secondary-foreground font-semibold shadow-glow-secondary hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
